   ...
   {"use strict";
    ...
    var
     ...
     cst_clock_gettime_CLOCK_REALTI=
      caml_string_of_jsbytes("clock_gettime(CLOCK_REALTIME) failed"),
     Base_Int63=global_data.Base__Int63,
     Base=global_data.Base;
    function nanoseconds_since_unix_epoch(param)
     {var t=runtime.time_now_nanoseconds_since_unix_epoch_or_zero(0);
      return caml_call2(Base_Int63[17],t,Base_Int63[44])
              ?t
              :caml_call1(Base[220],cst_clock_gettime_CLOCK_REALTI)}
