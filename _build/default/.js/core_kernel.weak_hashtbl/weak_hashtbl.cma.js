(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     cst_Weak_hashtbl_Import=caml_string_of_jsbytes("Weak_hashtbl__Import"),
     cst_weak_hashtbl=caml_string_of_jsbytes("weak_hashtbl"),
     cst_weak_hashtbl_src_import_ml=
      caml_string_of_jsbytes("weak_hashtbl/src/import.ml"),
     cst=caml_string_of_jsbytes(""),
     cst_weak_hashtbl$0=caml_string_of_jsbytes("weak_hashtbl"),
     cst_weak_hashtbl$1=caml_string_of_jsbytes("weak_hashtbl"),
     cst_Weak_hashtbl_Import$0=caml_string_of_jsbytes("Weak_hashtbl__Import"),
     cst_Weak_hashtbl_add_exn_of_ke=
      caml_string_of_jsbytes("Weak_hashtbl.add_exn of key in use"),
     cst_Weak_hashtbl=caml_string_of_jsbytes("Weak_hashtbl"),
     cst_weak_hashtbl$2=caml_string_of_jsbytes("weak_hashtbl"),
     cst_weak_hashtbl_src_weak_hash=
      caml_string_of_jsbytes("weak_hashtbl/src/weak_hashtbl.ml"),
     cst$0=caml_string_of_jsbytes(""),
     cst_weak_hashtbl$3=caml_string_of_jsbytes("weak_hashtbl"),
     cst_weak_hashtbl$4=caml_string_of_jsbytes("weak_hashtbl"),
     cst_Weak_hashtbl$0=caml_string_of_jsbytes("Weak_hashtbl"),
     ...
     Weak_hashtbl=[0];
    caml_register_global(21,Weak_hashtbl,"Weak_hashtbl__");
    ...
    caml_call1(Ppx_module_timer_runtime[5],cst_Weak_hashtbl_Import$0);
    var
     Weak_hashtbl_Import=
      [0,
       _a_,
       ...
       _iz_,
       _iA_];
    caml_register_global(27,Weak_hashtbl_Import,"Weak_hashtbl__Import");
    caml_call1(Ppx_module_timer_runtime[4],cst_Weak_hashtbl);
    caml_call1(Ppx_bench_lib_Benchmark_accumu[1][1],cst_weak_hashtbl$2);
    caml_call1(Expect_test_collector[4][1],cst_weak_hashtbl_src_weak_hash);
    caml_call2(Ppx_inline_test_lib_Runtime[2],cst_weak_hashtbl$3,cst$0);
    var
     _iF_=[0,caml_string_of_jsbytes("_")],
     ...
     _iG_=
      [0,
       ...
       2177,
       2200],
     _iB_=[0,caml_string_of_jsbytes("thread_safe_run_when_unused_data")],
     _iC_=[0,caml_string_of_jsbytes("keys_with_unused_data")],
     _iD_=[0,caml_string_of_jsbytes("entry_by_key")];
    function sexp_of_t(of_a,of_b,param)
     {var v_keys_with_unused_data=param[2],v_entry_by_key=param[1],bnds=0;
      ...
      var
       arg=caml_call1(Sexplib0_Sexp_conv[24],_iQ_),
       bnds$0=[0,[1,[0,_iB_,[0,arg,0]]],bnds],
       arg$0=caml_call2(Thread_safe_queue[1],of_a,v_keys_with_unused_data),
       bnds$1=[0,[1,[0,_iC_,[0,arg$0,0]]],bnds$0],
       _iR_=caml_call1(Weak_pointer[1],of_b),
       arg$1=caml_call3(Core_kernel_Hashtbl[3],of_a,_iR_,v_entry_by_key),
       bnds$2=[0,[1,[0,_iD_,[0,arg$1,0]]],bnds$1];
      return [1,bnds$2]}
    function create(growth_allowed,size,hashable)
     {function _iN_(_iP_){return 0}
      var _iO_=caml_call1(Thread_safe_queue[3],0);
      return [0,
              caml_call4
               (Core_kernel_Hashtbl[83][1],growth_allowed,size,hashable,0),
              _iO_,
              _iN_]}
    var Using_hashable=[0,create];
    function create$0(growth_allowed,size,m)
     {var _iM_=caml_call1(Base_Hashable[3],m);
      return caml_call3(Using_hashable[1],growth_allowed,size,_iM_)}
    ...
    function reclaim_space_for_keys_with_un(t)
     {for(;;)
       {if(caml_call2(_aH_,caml_call1(Thread_safe_queue[4],t[2]),0))
         {var
    ...
    function get_entry(t,key)
     {function _iL_(param){return caml_call1(Weak_pointer[2],0)}
      return caml_call3(Core_kernel_Hashtbl[50],t[1],key,_iL_)}
    function mem(t,key)
    ...
    function set_data(t,key,entry,data)
     {caml_call2(Weak_pointer[6],entry,data);
      ...
      return caml_call2(Core_kernel_Gc[10][3],data,_iK_)}
    ...
    function add_exn(t,key,data)
     {var entry=get_entry(t,key);
      if(caml_call1(Weak_pointer[4],entry))
       {var
         _iH_=function(param){return _iE_},
         _iI_=function(param){return _iF_};
        caml_call5
         (_cM_,
          0,
          _iG_,
          cst_Weak_hashtbl_add_exn_of_ke,
          t,
          function(_iJ_){return sexp_of_t(_iI_,_iH_,_iJ_)})}
    ...
    caml_call1(Expect_test_collector[4][2],0);
    caml_call1(Ppx_bench_lib_Benchmark_accumu[1][2],0);
    caml_call1(Ppx_module_timer_runtime[5],cst_Weak_hashtbl$0);
    var
     Weak_hashtbl$0=
      [0,
       sexp_of_t,
    ...
    caml_register_global(34,Weak_hashtbl$0,"Weak_hashtbl");
    return}
  (function(){return this}()));

//# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLjAsImZpbGUiOiJ3ZWFrX2hhc2h0YmwuY21hLmpzIiwic291cmNlUm9vdCI6IiIsIm5hbWVzIjpbXSwic291cmNlcyI6W10sIm1hcHBpbmdzIjoiOztJIiwic291cmNlc0NvbnRlbnQiOltdfQ==
